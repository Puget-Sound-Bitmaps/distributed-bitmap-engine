...
circuit a query that may \code{OR} more vectors, but has obtained a partial
vector that is entirely \code{1}s. Furthermore, we can improve the
...
\code{PUT} and \code{GET} RPCs. We would also like to make the system
