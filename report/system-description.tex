...
\procedure{Reallocate}. This is because for hash-mod-n an algorithms whose hash
...
not matter which order the vectors are \code{OR}ed together within the
